 ...
 *     05.  Data Counter         *
 *     06.  Datepicker js        *
 *     07.  Shuffle js    * (For Portfolio pages)
...
try {
    ...
    const runCounter = (counter_value) => {
        ...
        const updateCount = () => {
            ...
            if (progress < 1) {
                ...
                counter_value.classList.add('kv-counted');
                counter_value.addEventListener('animationend', () => {
                    counter_value.classList.remove('kv-counted');
                }, { once: true });
            }
        };
    ...
    if ('IntersectionObserver' in window) {
        ...
        counter.forEach(counter_value => counterObserver.observe(counter_value));
    } else {
